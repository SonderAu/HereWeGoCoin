...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0x6474;
...
const char     CRYPTONOTE_NAME[]                             = "HereWeGoCoin";
...
const int      P2P_DEFAULT_PORT                              = 52887;
//TODO This port will be used by the daemon to interact with simlewallet
const int      RPC_DEFAULT_PORT                              = 52888;
